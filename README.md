...
*   **Prompt Engineer:** Biswajit Rakshit
*   **AI Developer:** Google Gemini
...
*   **Modern UI/UX:** Clean aesthetics, intuitive layout, and optimized readability.
*   **Zero Bloat:** Lightweight code generated efficiently by AI.
...
2.  Structure the sections logically (Hero ➔ About ➔ Projects ➔ Contact).
3.  Refine the CSS for fluid responsiveness across all devices.
...
1.  **Clone this repository:**
    ```bash
    git clone https://github.com/Biswajit-Rakshit/Portfolio
    ```
2.  **Launch the site:**
    *   Simply double-click the `index.html` file to open it instantly in any browser.
...
*   **LinkedIn:** [Biswajit--Rakshit](https://www.linkedin.com/in/biswajit--rakshit/)
*   **GitHub:** [@Biswajit-Rakshit](https://github.com/Biswajit-Rakshit)
*   **Email:** biswa.rakshit@outlook.com

---
Built efficiently with ✦ Gemini.